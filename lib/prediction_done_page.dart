...
class PredictionDonePage extends StatefulWidget {
  const PredictionDonePage({super.key});

  @override
  State<PredictionDonePage> createState() => _PredictionDonePageState();
}

class _PredictionDonePageState extends State<PredictionDonePage> {
  @override
