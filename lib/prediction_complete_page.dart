// ignore_for_file: avoid_unnecessary_containers, non_constant_identifier_names, sized_box_for_whitespace, unnecessary_const, unnecessary_import
...
class PredictionCompletedPage extends StatefulWidget {
  const PredictionCompletedPage({super.key});

  @override
  State<PredictionCompletedPage> createState() =>
      _PredictionCompletedPageState();
}

class _PredictionCompletedPageState extends State<PredictionCompletedPage> {
  @override
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                      context,
                                      PageTransition(
                                          child: const PredictionDonePage(),
                                          type: PageTransitionType.fade));
                                },
                                child: Center(
                                    child: Image.asset("image/image 8.png")),
                              ),
                            ),
                          ),
                        ),
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: InkWell(
                    ...
                    child: Center(child: Image.asset("image/image 8.png")),
                  ),
                ),
              ),
            ],
