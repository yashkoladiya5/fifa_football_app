// ignore_for_file: avoid_unnecessary_containers, non_constant_identifier_names, sized_box_for_whitespace, unnecessary_const, unused_import

import 'package:flutter/material.dart';
import 'package:football_app/Widget/Textstyle.dart';
import 'prediction_done_page.dart';
...
class PredictionConfirmPage extends StatefulWidget {
  const PredictionConfirmPage({super.key});

  @override
  State<PredictionConfirmPage> createState() => _PredictionConfirmPageState();
}

class _PredictionConfirmPageState extends State<PredictionConfirmPage> {
  @override
